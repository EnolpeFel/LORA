...
const LoanApplicationScreen = ({ navigation }) => {
  ...
  const companies = [
    { 
      ...
      logo: require("C:/Users/user/my-expo-app/assets/ocs-fatima.png"),
  ...
  const submitApplication = () => {
    ...
    setApplicationResult(applicationData);
      ...
      {selectedCompanyInfo && (
        <React.Fragment>
          <View style={styles.modalHeader}>
            <Image source={selectedCompanyInfo.logo} style={styles.modalLogo} />
